...
class ManagerTest extends TestCaseAbstract
{
    ...
    public function testCreateMessage()
    {
        ...
        $returnedMessage = $manager->create($message);
        $this->assertSame('2016-09-01T05:15:25.821Z', $returnedMessage->getDateReceived());
        $this->assertEmpty($returnedMessage->getDateRead());
    }
